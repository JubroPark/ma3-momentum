...
5. [유니버스: 탑픽 선정 엔진 — 6단계 프레임워크](#5-유니버스-탑픽-선정-엔진)
...
탑픽은 아래 6가지 기준을 **순서대로** 통과한 종목만 편입한다. 상위 기준 탈락 시 하위 기준은 평가하지 않는다.

---

**① 시장 침투율 (Market Penetration)**

> "얼마나 큰 기회가 남았나" — TAM 대비 현재 침투율이 낮은 시장에서만 시작한다.

| 점검 항목 | 기준 |
| :--- | :--- |
| TAM 대비 침투율 | **10~20% 이하** 선호 (S커브 초기~중기 전환점 직전) |
| TAM 자체 성장성 | 시장이 정체된 경우 낮은 침투율도 무의미 — TAM도 확장 중이어야 함 |
| 확인 소스 | Gartner · IDC · Statista · 기업 IR TAM 가이던스 |

---

**② 시장 점유율 (Market Share)**

> "그 시장을 누가 지배하는가" — 현재 점유율보다 **증가 추세**가 더 중요하다.

| 점검 항목 | 기준 |
| :--- | :--- |
| 절대 순위 | 해당 산업 내 **#1 또는 #2** |
| 추세 | YoY 기준 점유율 **확대 중** |
| 주의 | Revenue 점유율 ≠ Unit 점유율 — 단가 인상 효과인지 구분 필요 |

---

**③ 성장률 & 경제적 해자 (Growth Rate & Economic Moat)**

> "빠르게 크면서 지킬 수 있는가" — 해자 없는 성장은 경쟁자를 불러 마진을 갉아먹는다.
...
| 매출 성장률 (YoY) | 20%+ |
| EPS 성장률 (YoY) | 15%+ |
| 마진 방향성 | 매출 증가와 함께 영업이익률도 확대 중 |
| SaaS/구독 기업 추가 | Rule of 40 (매출 성장률 + 영업이익률 ≥ 40) |

**경제적 해자 유형 (최소 1개 이상 필수)**

| 해자 유형 | 내용 |
| :--- | :--- |
| 네트워크 효과 | 사용자가 늘수록 서비스 가치 상승 |
| 전환 비용 | 고객이 구조적으로 이탈하기 어려운 생태계 |
| 원가 우위 | 구조적으로 경쟁사보다 싸게 만들 수 있음 |
| 무형 자산 | 특허·브랜드·규제 인허가 |
| 효율적 규모 | 틈새 시장 독점으로 경쟁 진입이 비경제적 |
| 데이터 우위 | AI 등 산업에서 고품질 데이터 독점 |

---

**④ 밸류에이션 — PEG**

> "성장 대비 적정 가격인가" — PEG = PER ÷ EPS 성장률.

| PEG 범위 | 해석 |
| :--- | :--- |
| < 1.0 | 성장 대비 저평가 — 매력적 |
| 1.0 ~ 2.0 | 적정 구간 — 해자 품질에 따라 판단 |
| > 2.0 | 성장이 완벽히 실현돼야 정당화 가능 — 신중 |

**PEG 부적합 시 대체 지표**

| 상황 | 대체 지표 |
| :--- | :--- |
| 적자 성장 기업 | EV/Sales, Price/Sales |
| 하드웨어/제조업 | EV/EBITDA |
| SaaS/구독 모델 | ARR 성장률, NRR(순수익 유지율) |

---

**⑤ 어닝 전망치 변화 (Earnings Estimate Revisions)**

> "월가 분석가들이 방향을 바꾸고 있는가" — 전망치 상향이 연속으로 나오는 구간이 주가 상승의 선행 지표.

| 점검 항목 | 기준 |
| :--- | :--- |
| EPS Revision 방향 | 최근 4~8주간 컨센서스가 **상향** 추세 |
| Beat & Raise 패턴 | 실적 발표마다 "예상치 초과 + 다음 분기 가이던스 상향" 반복 |
| 애널리스트 커버리지 | 커버하는 증권사 수 증가 → 기관 관심 확대 신호 |
| 목표주가 방향 | 최근 3개월 내 목표주가 상향 비율 > 하향 비율 |

> 확인 도구: Zacks Rank · Seeking Alpha Quant Ratings · FactSet Estimates · Bloomberg Consensus

---

**⑥ 모멘텀 (Momentum)**

> "돈이 실제로 이 주식으로 들어오고 있는가" — 펀더멘털이 좋아도 수급이 뒷받침돼야 한다.

**가격 모멘텀**

| 지표 | 기준 |
| :--- | :--- |
| 52주 고점 대비 위치 | 고점의 **75% 이상** (신고가 돌파 구간 주목) |
| 상대강도(RS Rating) | S&P500 대비 최근 12개월 수익률 **상위 80%** 이상 |
| 이동평균선 배열 | 주가 > 50일선 > 150일선 > 200일선 (우상향 정배열) |

**수급 모멘텀**

| 지표 | 기준 |
| :--- | :--- |
| 기관 순매수 | 최근 분기 기관 보유 지분 증가 |
| 거래량 | 주가 상승 시 평균 대비 `volRatio ≥ 1.30` |
| 내부자 매수 | 임원진 자사주 매수 = 강한 확신 신호 |
...
```
① 침투율 낮은 산업 스크리닝 (TAM 대비 10~20% 이하)
        ↓
② 해당 산업 점유율 #1~#2 기업 추려내기 + 점유율 확대 추세 확인
        ↓
③ 매출 20%+ 성장 + 해자 유형 1개 이상 확인
        ↓
④ PEG < 2 (또는 업종별 보완 지표)로 밸류에이션 검증
        ↓
⑤ 어닝 전망치 상향 추세 확인 (Beat & Raise 패턴)
        ↓
⑥ 모멘텀 필터 통과 (정배열 + volRatio ≥ 1.30) 시 편입
```

> **편입 기준**: 6개 중 4개 이상 충족 시 검토, 5~6개 충족 시 탑픽 편입 후보.

### 5.3 스코어링 (0~100)

```
TopPickScore =
    100 * ( w_growth   * norm(growthScore)       // ③ 성장률 반영
          + w_moat     * norm(moatScore)          // ③ 해자 반영
          + w_earn     * norm(earningsMomentum)   // ⑤ EPS revision 반영
          + w_finance  * norm(financialHealth) )  // ④ PEG/밸류에이션 반영

norm(x) = x / 5          // 0~5 입력을 0~1로
편입: TopPickScore >= toppick_threshold (기본 70)
```

> ①②⑥ (침투율·점유율·모멘텀)은 정성 평가로 `growthScore`·`moatScore`에 반영하거나 편입 전 1차 필터로 운영.
